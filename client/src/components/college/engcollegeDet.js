...
const EngCollegeDetails = () => {
    ...
    const fetchDataDetails = async () => {
        try {
            const response = await axios.get(`http://localhost:50/api/Engdata/${id}`);
                ...
                <div className="card mb-3">
                    ...
                    <div className="card-body">
                        ...
                        <table style={table}>
                            ...
                            <th>Eligibility</th>
                            <tr style={Tablerow}>
                                <td style={Header}>B.E/B.TECH</td>
                                <td style={Header}>5.42L per Year</td>
                                <td style={Header}>10,+12 With 75%</td>
                            </tr>
                            <tr style={Tablerow}>
                                <td style={Header}>M.E/M.TECH</td>
                                <td style={Header}>7.42L per Year</td>
                                <td style={Header}>Graduation with 60%</td>
                            </tr>
                            <tr style={Tablerow}>
                                <td style={Header}>P.HD</td>
                                <td style={Header}>8L per Year</td>
...
export default EngCollegeDetails;
